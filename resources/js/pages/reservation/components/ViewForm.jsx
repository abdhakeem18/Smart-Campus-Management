...
function ViewReservation({ onApprove, data, loading, success, error }) {
                            ...
                            <CardContent>
                                {data?.equipment_id &&
                                    ...
                                    >
                                        ...
                                        {contextData.equipments[data?.equipment_id]}
                                    </Typography>
                                }
                                <Typography
                                    variant="body1"
                                ...
                                >
                                    ...
                                    {`${data?.course?.course_name} (${data?.course?.course_code})`}
                                </Typography>
                                ...
                                >
                                    ...
                                    {`${data?.subject?.subject_name} (${data?.subject?.subject_code})`}
                                </Typography>
                                <Divider sx={{ my: 2 }} />
                            </CardContent>
                        </Card>
